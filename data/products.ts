...
export const PRODUCTS: Product[] = [
  {
    ...
    subtitle: 'By the product of WASEER Dawa Khana, Bait Hazari • 100% Herbal Hair Growth & Root Strengthening',
    ...
    description: 'Authentic unani cold-pressed herbal formula by WASEER Dawa Khana, Bait Hazari. Formulated with pure Amla, Sikakai, Kalonji, and nourishing botanical extracts to halt hair fall, strengthen weak roots, eliminate dandruff, and stimulate thick, lustrous hair growth.',
    ritualStory: 'Formulated in Bait Hazari using traditional unani preparation methods. 100% chemical-free, steroid-free, and mineral oil-free. Every drop delivers pure natural nourishment directly to hair follicles.',
    benefits: [
