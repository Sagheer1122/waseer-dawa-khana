...
export const PRODUCTS: Product[] = [
  {
    ...
    originalPrice: 36.00,
    sizes: [
      { size: '50ml', price: 29.99, label: 'Travel / Starter' },
      { size: '100ml', price: 48.00, label: 'Standard Ritual (Most Popular)', isPopular: true },
      { size: '150ml', price: 64.00, label: 'Ritualist Deluxe' },
    ],
    images: [
  ...
  },
  {
    ...
    basePrice: 34.99,
    sizes: [
      { size: '50ml', price: 34.99, label: 'Travel Flacon' },
      { size: '100ml', price: 54.00, label: 'Standard Ritual', isPopular: true },
      { size: '150ml', price: 72.00, label: 'Ritualist Value' },
    ],
    images: [
      'https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?auto=format&fit=crop&w=1200&q=85',
      'https://images.unsplash.com/photo-1617897903246-719242758050?auto=format&fit=crop&w=1200&q=85',
  ...
  },
  {
    ...
    basePrice: 31.99,
    sizes: [
      { size: '50ml', price: 31.99, label: 'Starter' },
      { size: '100ml', price: 49.00, label: 'Standard Ritual', isPopular: true },
      { size: '150ml', price: 66.00, label: 'Ritualist Value' },
    ],
    images: [
      'https://images.unsplash.com/photo-1617897903246-719242758050?auto=format&fit=crop&w=1200&q=85',
      'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=1200&q=85',
  ...
  },
  {
    ...
    basePrice: 28.99,
    sizes: [
      { size: '50ml', price: 28.99, label: 'Standard Flacon' },
      { size: '100ml', price: 46.00, label: 'Ritual Size', isPopular: true },
      { size: '150ml', price: 62.00, label: 'Salon Size' },
    ],
    images: [
  ...
  },
  {
    ...
    basePrice: 26.99,
    sizes: [
      { size: '50ml', price: 26.99, label: 'Starter' },
      { size: '100ml', price: 42.00, label: 'Standard Ritual', isPopular: true },
      { size: '150ml', price: 58.00, label: 'Value Flacon' },
    ],
    images: [
  ...
  },
  {
    ...
    basePrice: 32.99,
    sizes: [
      { size: '50ml', price: 32.99, label: 'Starter' },
      { size: '100ml', price: 50.00, label: 'Standard Ritual', isPopular: true },
      { size: '150ml', price: 68.00, label: 'Deluxe' },
    ],
    images: [
  ...
  },
  {
    ...
    basePrice: 36.99,
    sizes: [
      { size: '50ml', price: 36.99, label: 'Starter' },
      { size: '100ml', price: 58.00, label: 'Standard Ritual', isPopular: true },
    ],
    images: [
  ...
  },
  {
    ...
    basePrice: 33.99,
    sizes: [
      { size: '50ml', price: 33.99, label: 'Starter' },
      { size: '100ml', price: 52.00, label: 'Standard Ritual', isPopular: true },
    ],
    images: [
  ...
  },
  {
    ...
    originalPrice: 96.97,
    sizes: [
      { size: '3 x 50ml Starter Set', price: 74.99, label: 'Starter Trio' },
      { size: '3 x 100ml Full Ritual Set', price: 119.00, label: 'Full Ritual Trio (Best Value)', isPopular: true },
    ],
    images: [
